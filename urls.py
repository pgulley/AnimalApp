...
urlpatterns = patterns('',
     ...
     url(r'^animals/(?P<animal_id>\d+)/connectanimal$','AniStat.views.ConnectAnimal'),
     ...
     url(r'login','AniStat.views.Login'),
     url(r'logout','AniStat.views.Logout'),
     url(r'newuser','AniStat.views.NewUser'),
     url(r'createuser','AniStat.views.CreateUser'),
